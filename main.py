...
# Function to generate HTML for downloading binary file
...
# Main function
def main():
    # Add background image CSS style
    st.markdown(
        """
        <style>
        body {
            background-image: url('https://images.pexels.com/photos/13569823/pexels-photo-13569823.jpeg?auto=compress&cs=tinysrgb&w=400&lazy=load');
